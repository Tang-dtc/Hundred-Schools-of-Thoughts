...
#3.Chinese Word Segmentation and label the type of word. 
...
#4.Select idioms (i) to analyse semantic annotation; 
...
#5.select the noun, verb, adjustive and adverb,generate the word frequency and wordcloud.
...
if __name__ == '__main__':
    tmpList = pandasreadTxt("Daojia.txt")
    # print(tmpList)
